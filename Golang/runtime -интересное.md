 ...
 - `runtime.NumCPU()`: Возвращает количество логических процессоров.
 - `runtime.MemStats()`: Предоставляет информацию о статистике памяти.
 - `runtime.GOOS()` - Возвращают операционную систему
 - `runtime.GOARCH()`: Возвращает архитектуру, на которой выполняется программа.
 - `runtime.Gosched()` - приостановить горутиной своё выполнение и позволить планировщику Go запустить другие горутины, которые находятся в состоянии готовности к выполнению.
